...
function FormPesanan () {
    ...
    // Variable nama perusahaan, metode pembayaran dan sesi
    ...
    useEffect (() => {
                ...
                switch (selectedValues.option){
                    ...
                    case "PK":
                        if(selectedValues.subOption === "Konseling"){
                            setSum(selectedSesi * 300000 + admin)
                            setSelectedValues({ ...selectedValues, sum: sum});
                        }
                        break
                    case "PIO":
                        if(selectedValues.subOption === "Psikotes"){
                            setSum(selectedSesi * 350000 + admin)
                            setSelectedValues({ ...selectedValues, sum: sum});
                        }
                        if(selectedValues.subOption === "Assessment-Center"){
                            setSum(selectedSesi * 2500000 + admin)
                            setSelectedValues({ ...selectedValues, sum: sum});
                        }
                        if(selectedValues.subOption === "Training-SDM"){
                            setSum(selectedSesi * 1500000 + admin)
                            setSelectedValues({ ...selectedValues, sum: sum});
                        }
                    break
                    case "PP":
                        if(selectedValues.subOption === "Psikotes"){
                            setSum(selectedSesi * 250000 + admin)
                            setSelectedValues({ ...selectedValues, sum: sum});
                        }
        ...
        sumPrice()
        fetchAllUser()
    }, [selectedSesi, sum, selectedOption, id, nama])
    // validation login
    const isLoggedIn = user?.name
    console.log("test",isLoggedIn)
    // Nama perusahaan, metode pembayaran dan sesi
